package com.chenyu.ssm.server.json.aspet;
...
import com.chenyu.ssm.server.json.ValidateFiled;
import com.chenyu.ssm.server.json.ValidateGroup;
...
public class ValidateAspectHandel {
    ...
    @Around("@annotation(com.chenyu.ssm.server.json.ValidateGroup)")
        ...
        try{
            ...
            if(flag){
                ...
                if(returnType == String.class){ //如果返回值为Stirng
                    return APIResponse.ofStatus(APIResponse.Status.NOT_VALID_PARAM);      //返回错误页面
